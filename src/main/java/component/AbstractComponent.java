...
public abstract class AbstractComponent<IN, OUT> implements Component {
    ...
    // The actual alpha that we use, changing depending on the actual update period
    // length
    ...
    public AbstractComponent(String id, ComponentType type) {
        ...
        this.executionTimeMetric = LiebreContext.operatorMetrics().newAverageTimeMetric(id, "EXEC");
    ...
    public boolean runFor(int rounds) {
        ...
        // Process while the component is enabled, the rounds are not finished and there
        // is actually
    ...
    /**
     * Update the cost and selectivity based on the tuples processed and the time it
     * took. <br>
