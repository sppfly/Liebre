...
/**
 * An {@link Operator} with two inputs (of possibly different types) and one
 * output.
 *
 ...
 */
public interface Operator2In<IN, IN2, OUT> extends Operator1In<IN, OUT> {

    /**
     * Apply a function to the input tuple, transforming it into zero or more output
     * tuples.
     *
    ...
    /**
     * Get an adapter of this component.operator that looks like a regular
     * {@link Operator1In} with its main input being the second input of this
     * {@link Operator2In}.
     *
     * @return An {@link Operator} instance which has {@link #getInput2()} as its
     *         input.
