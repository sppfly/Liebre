...
/**
 * Abstract implementation of {@link Operator} that handles basic changes to the
 * state of the component.
 *
 * @param <IN>  The type of input tuples.
 * @param <OUT> The type of output tuples.
 */
public abstract class AbstractOperator<IN, OUT> extends AbstractComponent<IN, OUT> implements Operator<IN, OUT> {
