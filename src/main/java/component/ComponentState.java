...
/**
 * Object that represents the state of all common stream components such as
 * operators, sinks and sources.
 *
 * @param <IN>  The type of the inputs of the component where the state belongs
 *              to.
 * @param <OUT> The type of the outputs of the component where the state belongs
 *              to.
 * @author palivosd
 */
public final class ComponentState<IN, OUT> {
    ...
    /**
     * Enable the state. Should always be called when calling
     * {@link Component#enable()}
     */
    public void enable() {
        type.validate(this);
    ...
    /**
     * Disable the state. Should always be called when calling
     * {@link Component#disable()}
     */
    public void disable() {
        for (Stream<?> input : inputs) {
            input.disable();
    ...
    /**
     * Get the unique numerical ID of the state. This can be the same or different
     * than {@link #getId()}.
     *
    ...
    public String toString() {
        return new ToStringBuilder(this).append("type", type).append("id", id).append("index", index)
                .append("inputs", inputs).append("outputs", outputs).append("enabled", enabled).toString();
    }
}
