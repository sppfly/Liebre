...
public class GenealogTuple extends BaseRichTuple implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(UID, genealogTuple.UID) && type == genealogTuple.type;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this).append("UID", UID).append("type", type).appendSuper(super.toString())
                .toString();
    }
}
