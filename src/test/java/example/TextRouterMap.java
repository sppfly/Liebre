...
public class TextRouterMap {
    ...
    public static void main(String[] args) {
        ...
        Operator<MyTuple, MyTuple> filterHigh = q.addFilterOperator("fHigh", t -> {
            Util.sleep(100);
        ...
        q.connect(i1, inputReader).connect(inputReader, router).connect(router, filterHigh).connect(filterHigh, o1)
